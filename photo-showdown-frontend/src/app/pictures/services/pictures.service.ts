...
export class PicturesService {
	...
	getMyPictures(): Observable<APIResponse<Picture[]>> {
		return this.http.get<APIResponse<Picture[]>>(this.apiURL + "/GetMyPictures", this.httpOptions).pipe(
			map((response) => {
	...
	deletePicture(id: number): Observable<EmptyAPIResponse> {
		return this.http.delete<APIResponse<Picture[]>>(this.apiURL + "/DeletePicture/" + id, this.httpOptions);
	}
	/**
	...
	uploadPictures(pictureFiles: FileList): Observable<APIResponse<Picture[]>> {
		...
		return this.http.post<APIResponse<Picture[]>>(this.apiURL + "/UploadPicture", formData, this.httpUploadOptions);
	}
}
