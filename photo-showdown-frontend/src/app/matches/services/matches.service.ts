...
export class MatchesService {
	...
	createNewMatch(): Observable<APIResponse<Entity>> {
		return this.http.post<APIResponse<Entity>>(this.apiURL + "/CreateNewMatch", this.httpOptions);
	}
	/**
	 *
	...
	getMatchById(matchId: number): Observable<APIResponse<Match>> {
		return this.http.get<APIResponse<Match>>(this.apiURL + `/GetMatchById/${matchId}`, this.httpOptions);
	}
	/**
	 *
	...
	joinMatch(matchId: number): Observable<EmptyAPIResponse> {
		return this.http.post<EmptyAPIResponse>(this.apiURL + `/JoinMatch/${matchId}`, this.httpOptions);
	}
	/**
	 *
	...
	leaveMatch(matchId: number): Observable<EmptyAPIResponse> {
		return this.http.delete<EmptyAPIResponse>(this.apiURL + `/LeaveMatch/${matchId}`, this.httpOptions);
	}
	/**
	 *
	 * starts the match
	...
	getCurrentMatch(): Observable<APIResponse<Match>> {
		return this.http.get<APIResponse<Match>>(this.apiURL + "/GetCurrentMatch", this.httpOptions);
	}
	/**
	 *
	 * starts the match
	...
	startMatch(matchSettings: MatchSettings): Observable<EmptyAPIResponse> {
		return this.http.post<EmptyAPIResponse>(this.apiURL + `/StartMatch`, matchSettings, this.httpOptions);
	}
	...
	voteForPicture(matchId: number, roundIndex: number, pictureSelectedId: number): Observable<EmptyAPIResponse> {
		return this.http.post<EmptyAPIResponse>(
